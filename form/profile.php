...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
	...
	{
	?>
	<a class="navbar-brand" href="profile.php" style="color:black; text-decoratio:none;"><i class="far fa-user"><?php if(isset($cust_id)) { echo $qqr['fld_name']; }?></i></a>
	<?php
	}
	?>
            ...
            <div class="tab-pane fade" id="manageaccount" role="tabpanel" aria-labelledby="manageaccount-tab">
			    <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="tel" id="address" class="form-control" name="address" value="<?php if(isset($fld_address)){ echo $fld_address;}?>" placeholder="" required>
                    </div>
